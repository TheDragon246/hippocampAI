...
#SBATCH --output=job_outputs/job_output_hippocampus_fs_37_%j.out
...
echo 'pointnet_hippocampus_fs_37.py'
CUDA_LAUNCH_BLOCKING=1 python pointnet_hippocampus_fs_37.py
