...
#SBATCH --output=job_outputs/job_output_parahippocampus_fs_01_%j.out
...
echo 'pointnet_parahippocampus_fs_01.py'
CUDA_LAUNCH_BLOCKING=1 python pointnet_parahippocampus_fs_01.py
