...
#SBATCH --output=job_outputs/job_output_hippocampus_fs_01_%j.out
...
echo 'pointnet_hippocampus_fs_01.py'
CUDA_LAUNCH_BLOCKING=1 python pointnet_hippocampus_fs_01.py
