...
#SBATCH --output=job_outputs/job_output_isthmuscingulate_fs_08_%j.out
...
echo 'pointnet_isthmuscingulate_fs_08.py'
CUDA_LAUNCH_BLOCKING=1 python pointnet_isthmuscingulate_fs_08.py
