...
#SBATCH --output=job_outputs/job_output_entorhinal_fs_65_%j.out
...
echo 'pointnet_entorhinal_fs_65.py'
CUDA_LAUNCH_BLOCKING=1 python pointnet_entorhinal_fs_65.py
