...
#SBATCH --output=job_outputs/job_output_DenseNet_isthmuscingulate_65_%j.out
...
echo 'DenseNet_isthmuscingulate_65.py'
CUDA_LAUNCH_BLOCKING=1 python DenseNet_isthmuscingulate_65.py
