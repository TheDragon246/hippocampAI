...
#SBATCH --output=job_outputs/job_output_DenseNet_parahippocampus_14_%j.out
...
echo 'DenseNet_parahippocampus_14.py'
CUDA_LAUNCH_BLOCKING=1 python DenseNet_parahippocampus_14.py
