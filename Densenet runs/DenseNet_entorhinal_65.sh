...
#SBATCH --output=job_outputs/job_output_DenseNet_entorhinal_65_%j.out
...
echo 'DenseNet_entorhinal_65.py'
CUDA_LAUNCH_BLOCKING=1 python DenseNet_entorhinal_65.py
