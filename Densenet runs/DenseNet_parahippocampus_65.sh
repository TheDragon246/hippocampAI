...
#SBATCH --output=job_outputs/job_output_DenseNet_parahippocampus_65_%j.out
...
echo 'DenseNet_parahippocampus_65.py'
CUDA_LAUNCH_BLOCKING=1 python DenseNet_parahippocampus_65.py
