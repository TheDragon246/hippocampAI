...
#SBATCH --output=job_outputs/job_output_DenseNet_hippocampus_65_%j.out
...
echo 'DenseNet_hippocampus_65.py'
CUDA_LAUNCH_BLOCKING=1 python DenseNet_hippocampus_65.py
