...
#SBATCH --output=job_outputs/job_output_DenseNet_isthmuscingulate_08_%j.out
...
echo 'DenseNet_isthmuscingulate_08.py'
CUDA_LAUNCH_BLOCKING=1 python DenseNet_isthmuscingulate_08.py
