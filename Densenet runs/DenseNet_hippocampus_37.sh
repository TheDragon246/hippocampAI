...
#SBATCH --output=job_outputs/job_output_DenseNet_hippocampus_37_%j.out
...
echo 'DenseNet_hippocampus_37.py'
CUDA_LAUNCH_BLOCKING=1 python DenseNet_hippocampus_37.py
