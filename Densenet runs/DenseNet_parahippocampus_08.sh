...
#SBATCH --output=job_outputs/job_output_DenseNet_parahippocampus_08_%j.out
...
echo 'DenseNet_parahippocampus_08.py'
CUDA_LAUNCH_BLOCKING=1 python DenseNet_parahippocampus_08.py
