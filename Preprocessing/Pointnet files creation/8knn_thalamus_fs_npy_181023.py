...
class BrainScanDataset(Dataset):
    ...
    def raw_file_names(self):
        ...
        self.file_list = ["{}/{}/{}_thalamusmasked_brain_standardized_noneg_normalized.npy".format(regions_dir, self.region_name, subj) for subj in subjs]
    ...
    def process(self):
        ...
        if file_exists == True:
            ...
            for npy_file in self.raw_file_names:
                ...
                torch.save(data, osp.join(save_dir, f'8knn_thalamus_fs_{subject}.pt'))
                del data
...
region_name = "freesurfer_121023/thalamus_standardized_normalized"
save_dir = "/blue/stevenweisberg/share/hippocampAI/8knn_thalamus_fs_181023"
