...
#SBATCH --output=job_outputs/job_output_8knn_isthmuscingulate_fs_npy_181023_%j.out
...
echo '8knn_isthmuscingulate_fs_npy_181023.py'
CUDA_LAUNCH_BLOCKING=1 python 8knn_isthmuscingulate_fs_npy_181023.py
