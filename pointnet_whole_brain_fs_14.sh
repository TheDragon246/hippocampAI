...
#SBATCH --output=job_outputs/job_output_whole_brain_fs_14_%j.out
...
echo 'pointnet_whole_brain_fs_14.py'
CUDA_LAUNCH_BLOCKING=1 python pointnet_whole_brain_fs_14.py
