...
#SBATCH --output=job_outputs/job_output_DenseNet_whole_brain_37_%j.out
...
echo 'DenseNet_whole_brain_37.py'
CUDA_LAUNCH_BLOCKING=1 python DenseNet_whole_brain_37.py
